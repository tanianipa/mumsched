...
<table>
	...
	<td>
	 ...
	 <c:forEach var ="b" items="${listOfBlocks}" varStatus="k">  		
	  	<c:forEach var ="b" items="${faculty.prefferedBlocks}" varStatus="i">  		
	  		<input name="prefferedBlocks[${i.index}]" type="checkbox" value="${b.blockName}"> ${b.blockName}
	  		<br/>
	  	</c:forEach>
  	</c:forEach>
	</td>
